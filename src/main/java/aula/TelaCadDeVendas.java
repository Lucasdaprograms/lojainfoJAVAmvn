...
import aula.model.Cliente;
import aula.model.Vendas;
import aula.persistence.VendasJdbcDAO;
import aula.persistence.ClienteJdbcDAO;
import aula.persistence.JdbcUtil;
...
public class TelaCadDeVendas extends TelaDeCadastro {
	...
	public TelaCadDeVendas() {
		super(6, 2);// quatro linhas e duas colunas
